...
getopts(opts, ...
 'maxits',     50,...         % maximum of iterations
 'maxevals',   2e3,...         % maximum # of function evaluations
 'maxdeep',    2e3,...        % maximum number of side divisions
 ...
 'tol',        0.001,...       % allowable relative error if f_reach is set
